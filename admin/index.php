					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a class="english"><img src="../assets/img/langage/gb.png" alt=""> English</a>
								</li>
										...
										<li>
											<a href="javascript:;">
												...
												<span class="details">
													...
													<b>Sneha Jogi </b>Envyer un message. </span>
											</a>
										</li>
										<li>
											<a href="javascript:;">
												...
												<span class="details">
													...
													<b>Ravi Patel </b>like photo. </span>
											</a>
										</li>
										<li>
											<a href="javascript:;">
											...
											<a href="javascript:;">
												...
												<span class="details">
													<span class="notification-icon circle red"><i
															class="fa fa-times"></i></span> Erreur d'application. </span>
											</a>
										</li>
									</ul>
									<div class="dropdown-menu-footer">
										<a href="javascript:void(0)"> Tous notifications </a>
									</div>
								</li>
							</ul>
						</li>
	...
	<!--						<li class="sidebar-user-panel">
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; ZOMA W Rodrigue
				<a href="wrodriguezoma@gmail.com" target="_top" class="makerCss">Redstar Theme</a>
			</div>
